...
class DocumentGenerator:
    ...
    def generate(self, urls):
        ...
        with ThreadPoolExecutor(max_workers=5, 
                                thread_name_prefix=f"{multiprocessing.current_process().name}_thread_") as executor:
    ...
    def create_doc_try_except(self, url, i):
        try:
            ...
            print(f'{threading.current_process().name} processed url index: {i}, total images generated by generator: {self.image_counter}')
